...
public class MusicPlayer extends PlaybackListener {
    ...
    public void loadPlaylist(File playListFile){
        ...
        if (playlist.size()> 0){
            ...
            curentSong = playlist.get(0);
            currentFrame =0;

            musicPlayerGUI.enablePauseButtonDisablePlayButton();
            musicPlayerGUI.updatesongTitleArtist(curentSong);
            musicPlayerGUI.updateplaybackslider(curentSong);
    ...
    public void nextSong(){
        ...
        curentSong= playlist.get(currentPlaylistIndex);
